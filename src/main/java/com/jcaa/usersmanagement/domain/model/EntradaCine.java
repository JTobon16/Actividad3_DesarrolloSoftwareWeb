...
/**
 * Modelo de dominio que representa una entrada de cine.
 *
 * REGLA HEXAGONAL: Esta clase NO tiene ninguna anotación de JPA ni de Spring.
 * Es Java puro. La infraestructura (BD) se adapta a este modelo, no al revés.
 */
public class EntradaCine {
    ...
    public EntradaCine(Long id, String codigoEntrada, String pelicula, String sala,
